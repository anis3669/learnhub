    ...
    <section id="features" class="py-24 px-4 bg-gray-50">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                @foreach([
                    ['icon'=>'M15 10l4.553-2.169A1 1 0 0121 8.763V15.5a1 1 0 01-1.447.894L15 14M3 8a2 2 0 012-2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8z', 'title'=>'Video Lessons', 'desc'=>'Stream HD video content with YouTube. Pause, rewind, and learn at your own pace.', 'accent'=>'from-blue-500 to-blue-600'],
